...
class CarFactory {
  ...
  // - getInstance() 같은 스태틱 메서드를 통해 인스턴스를 한 개만 만들어 사용하기 위함이다.
...
public class Exam0222 {
  ...
  public static void main(String[] args) {
	  ...
	  // 자동차 공장 객체를 먼저 만든다.
	 CarFactory factory = CarFactory.getInstance(); // 컴파일 오류! 왜? 생성자가 private 이다.
    ...
    // new 연산자가를 이용하지 않고 스태틱 메서드를 호출해서 인스턴스를 생성하는 경우
    // 다음 둘 중 하나다!
